...
//		test.add_new_car();
    ...
    private void find_customer(ApplicationContext context) throws ParseException {
        Car car = new Car("Ford Kuga");
        JDBCCustomerRepositoryImpl service = (JDBCCustomerRepositoryImpl) context.getBean("jDBCCustomerRepositoryImpl");
        Customer customer = service.getCustomerByName("Isik");
        System.out.println("is rental rented? " + customer.getAge());
    }
